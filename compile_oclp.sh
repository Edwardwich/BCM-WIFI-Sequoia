...
# Install the project (it may not require sudo, verify if necessary)
bash install.sh
cd ../..
...
# Run the build command without sudo
echo "Generating OpenCore-Patcher.app..."
python3 -m PyInstaller ./OpenCore-Patcher-GUI.spec --noconfirm || { echo "Error: Failed to generate OpenCore-Patcher.app."; exit 1; }
